...
* [ ] Repo initialized (Prompt 0)
* [ ] Worker routes implemented (Prompt 1)
* [ ] Sanitization + validation (Prompt 2)
* [ ] Slack module (Prompt 3)
* [ ] Postmark module (Prompt 4)
* [ ] Rate limiter (Prompt 5)
* [ ] Submit handler wiring (Prompt 6)
* [ ] Client scaffold (Prompt 7)
* [ ] Client-wire + error handling (Prompt 8)
